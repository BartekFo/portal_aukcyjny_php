    ...
    <div class="cards_wrapper">
        <div class="categorySection_container_card">
            <div class="categorySection_container_card_info">
                <div class="categorySection_container_card_info_img"></div>
                <h1 class="categorySection_container_card_info_title">
                    Nazwa produktu
                </h1>
                <div class="categorySection_container_card_info_price">
                    <h1 class="categorySection_container_card_info_price_text">Cena</h1>
                    <button class="categorySection_container_card_info_price_btn">Zobacz więcej</button>
                </div>
            </div>
        </div>
        <div class="categorySection_container_card">
